...
def usage():
    ...
    train_parser.add_argument('--seq_len', type=int, default=128, help='input sequence length of Informer encoder')
    train_parser.add_argument('--label_len', type=int, default=60, help='start token length of Informer decoder')
    ...
    train_parser.add_argument('--d_model', type=int, default=24, help='dimension of model')
    train_parser.add_argument('--n_heads', type=int, default=2, help='num of heads')
    train_parser.add_argument('--e_layers', type=int, default=2, help='num of encoder layers')
    train_parser.add_argument('--d_layers', type=int, default=2, help='num of decoder layers')
