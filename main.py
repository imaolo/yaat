...
STATIC_DIR = os.path.join(BASE_DIR, 'yaat/client/dist')

document_models = [TopMoverQueryDoc, TopMoverDoc, JobDoc]
...
async def lifespan(_: FastAPI):
    ...
    jobstore = MongoDBJobStore(client=client.delegate, database='yaatdb', collection=JobDoc.__name__)
