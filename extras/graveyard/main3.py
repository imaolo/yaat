...
def usage():
    ...
    train_parser.add_argument('--seq_len', type=int, default=720, help='input sequence length of Informer encoder')
    train_parser.add_argument('--label_len', type=int, default=128, help='start token length of Informer decoder')
    ...
    train_parser.add_argument('--d_model', type=int, default=800, help='dimension of model')
    train_parser.add_argument('--n_heads', type=int, default=8, help='num of heads')
    train_parser.add_argument('--e_layers', type=int, default=3, help='num of encoder layers')
...
if args.cmd == 'maester':
    ...
    def wrap_print(printcall: Callable): print(); printcall(); print()
    ...
    if not args.models and not args.datasets and not args.preds:
        wrap_print(print_datasets); wrap_print(print_models); wrap_print(print_preds)
    if args.models is not None: wrap_print(print_models)
    if args.datasets is not None: wrap_print(print_datasets)
    if args.preds is not None: wrap_print(print_preds)
