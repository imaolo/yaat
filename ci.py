...
if not SSH_USERNAME or not SSH_KEY or not SSH_HOST or not GITHUB_PAT:
    raise RuntimeError("SSH_USERNAME, SSH_KEY, SSH_HOST, and GITHUB_PAT required")
...
if __name__ == "__main__":
    ...
    ssh_cmd += f"git pull https://imaolo:{GITHUB_PAT}@github.com/imaolo/test-cicd && "
