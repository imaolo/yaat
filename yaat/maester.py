...
class Maester:
    ...
    def __init__(self, connstr:Optional[str]='mongodb://54.205.245.140:27017/', dir:str='./yaatdb_local'):
        # create (and possibly start) db
        self.dir = dir
        self.connstr = connstr
        self.dbc = self.startlocdb(self.dir) if self.connstr is None else self.conndb(self.connstr)
